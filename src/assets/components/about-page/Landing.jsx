...
const Landing = () => {
  return (
    <div className='w-10/12 h-auto mx-auto mt-8 flex border-blue-900 rounded-xl bg-white scroll-smooth'>
        <div className="text w-2/3  p-6">
            <div className="heading p-3">
                <p className='text-4xl text-cyan-950 font-bold'>Hello! I'm Anand, a part-time React Front-end Developer and full-time Student ;)</p>
            </div>
            ...
            <div className="content p-3 text-lg font-normal text-black text-wrap">
                ...
                <p className='p-2'>I'm currently looking for an Software Developer Internship. If you're willing to give me an opportunity, do check out my Github and Linkedin pages below ⬇</p>
            </div>
